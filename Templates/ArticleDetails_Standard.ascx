...
<div class="Article" id="container_articulo" runat="server">
	<h1><asp:Label cssclass="Head" id="lblTitle" runat="server" /></h1>
	<div class="detailsStats">
	<asp:Label ID="lblCategoria1" runat="server" /><asp:Label ID="lblCategoria2" runat="server" />
	<div runat="server" id="phTags"></div>
    ...
    <asp:Label ID="lblNroSemana" runat="server" Visible="false"></asp:Label>
    
        Categories: <%#GetCategoryList()%> |
		Author: <asp:Hyperlink id="hypUser" runat="server" /> | 
		Posted: <asp:Literal ID="litDatePosted" Runat="server" /> |
		Views: <asp:Literal ID="litViews" Runat="server" /><br />
