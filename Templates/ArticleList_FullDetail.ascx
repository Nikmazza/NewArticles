	...
	<ItemTemplate>
		...
		<div class="Head">
			...
			<div class="normal">
                ...
                <asp:Literal id="litDescription" runat="server" text='<%# Server.HtmlDecode(DataBinder.Eval(Container.DataItem,"Description")) %>' />
				<asp:Literal id="litArticle" runat="server" text='<%# "<br/>" & GetArticleDetailText(DataBinder.Eval(Container.DataItem,"Article")) %>' />
			</div>
