...
<article id="container_articulo" class="articleConexion" runat="server">
    <div class="row">
		...
		<div class="col-xs-5 col-md-4 marginTop20 text-right">
			...
			<div class="addthis_toolbox row" id="addthis" runat="server" Visible="False" style="margin-top: 10px;">
				<div class="col-xs-8 col-xs-offset-2 col-md-4 col-md-offset-7">
					<div class="row">
						<div class="col-xs-4"><a class="addthis_button_whatsapp visible-xs" addthis:url="[URL]"><img alt="whatsapp" src="/portals/0/Images/Commons/whatsapp.png" /></a><a class="addthis_button_email hidden-xs" addthis:url="[URL]"><img alt="email" src="/portals/0/Images/Commons/email.png" /></a></div><div class="col-xs-4"><a class="addthis_button_twitter" addthis:url="[URL]"><img alt="twitter" src="/portals/0/Images/Commons/twitter.png" /></a></div><div class="col-xs-4"><a class="addthis_button_facebook" addthis:url="[URL]"><img alt="facebook" src="/portals/0/Images/Commons/facebook.png" /></a></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-xs-12 col-md-4">
			<div class="row">
				<div class="col-xs-12 col-md-6 col-md-offset-0">
					<asp:Label id="lblNroRevista" runat="server"/>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12">
					<h5 class="masRevista">MÁS ARTÍCULOS DE ESTE NÚMERO</h5>
				</div>
				<div class="col-xs-12" id="masRevista" runat="server">		
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12">
					<h5 class="masRelacionados">ARTÍCULOS RELACIONADOS</h5>
				</div>
				<div class="col-xs-12" id="masRelacionados" runat="server">
