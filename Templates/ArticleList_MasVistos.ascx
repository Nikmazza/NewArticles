...
<asp:DataList id="lstArticles" CssClass="articleConexion" runat="server" OnItemDataBound="Item_Bound" RepeatLayout="Flow" RepeatDirection="Horizontal" EnableViewState="false">
	<HeaderTemplate>
			<div class="row">
			<div class="col-xs-12">
				<h5 class="masRelacionados">ARTÍCULOS MÁS VISTOS</h5>
			</div>
	</HeaderTemplate>
	<ItemTemplate>
		<div class="col-xs-12 masRelacionados-item">
			<div class="row no-gutters">
				...
				<div class="col-xs-10">
					<p><asp:Label id="lblPublishDate" Visible="True" runat="server" text='<%# DataBinder.Eval(Container.DataItem,"NumberOfViews")%>' /> vistas</p>
				</div>
			</div>
		</div>
